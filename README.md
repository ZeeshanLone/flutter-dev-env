...
This is latest version of the original work by [matsp](https://github.com/matsp/docker-flutter)

- openjdk version 17
- Flutter version 3.22.0
- Andriod SDK version 34
...
{
  "name": "FlutterDevEnv",
  "image": "zeeshanlone/flutter-dev-env:stable",
  "customizations": {
        "vscode": {
            "extensions": [
                "dart-code.flutter",
